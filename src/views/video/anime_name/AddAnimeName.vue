      ...
      <a-form labelAlign="right">
        <a-row>
          <a-col :span="12">
            ...
            >
              <a-input v-model:value="addModel.name" style="width: 260px" placeholder="请填写动漫名"></a-input>
            </a-form-item>
            <a-form-item
                label="动漫封面"
            ...
            >
              <a-upload
                  ...
                  name="file"
                  :multiple="true"
                  action="http://localhost:8089/zy/api/anime_name/uploadAnimeCover"
                  @change="UploadAnimeCover"
              >
...
import AnimeName from "@/composable/anime_name/AnimeName";
...
const { addModel, rules } = AnimeName()
...
const UploadAnimeCover = (info: FileInfo) => {
...
const show = (type: string, row: AnimeNameModel)=> {
  drawer.width = 720
  resetFields();

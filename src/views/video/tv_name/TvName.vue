<template>
  ...
  <!-- 新增、编辑 -->
  <AddTvName ref="addRef" class="btn btn-default"  @save="save"></AddTvName>

</template>

<script setup lang="ts">
import useTvName from "@/composable/tv_name/useTvName";
import TvNameTable from "@/composable/tv_name/TvNameTable";
import AddTvName from "@/views/video/tv_name/AddTvName.vue";
...
const { addBtn, editBtn, deleteBtn, addRef, save } = useTvName(getList);
